...
namespace CoffeeShopApp.Data.Migrations
{
    ...
    [Migration("20200525004758_AddedColumnsForDeletion")]
    partial class AddedColumnsForDeletion
    {
            ...
            modelBuilder.Entity("CoffeeShopApp.Data.Models.EmployeeModel", b =>
                {
                    ...
                    b.HasData(
                        new { Id = new Guid("0cc1a9e2-41ea-4c5c-af13-9053a449fd19"), AccessFailedCount = 0, ConcurrencyStamp = "05a9392e-7a91-45a0-bd57-d2145c34689a", DateofBirth = new DateTime(1980, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Email = "admin@coffeeshop.app", EmailConfirmed = true, FirstName = "Master", JMBG = "0101980563922", LastName = "Admin", LockoutEnabled = false, NormalizedEmail = "ADMIN@COFFEESHOP.APP", NormalizedUserName = "ADMIN", PasswordHash = "AQAAAAEAACcQAAAAEORt9VwAa7DVDbKqsl9MQMWvSKgvLveBBBOFZ5Yw3Jjw7ZNRSXNpXetWjeMspq4x3w==", PhoneNumberConfirmed = true, SecurityStamp = "00000000-0000-0000-0000-000000000000", TwoFactorEnabled = false, UserName = "admin" }
                    );
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "d595e861-62f6-48c9-90c5-376f635cc26d", ConcurrencyStamp = "4b5d0a62-fd74-4424-9439-74962d497c74", Name = "Admin", NormalizedName = "ADMIN" },
                        new { Id = "7995a0b7-b149-480c-965e-9e5be525ec56", ConcurrencyStamp = "b111f86b-4186-4f6f-89d4-09814ca2772c", Name = "Employee", NormalizedName = "EMPLOYEE" }
                    );
                });
