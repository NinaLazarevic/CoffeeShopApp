...
namespace CoffeeShopApp.Data.Migrations
{
    ...
    [Migration("20200525012002_SeedTestAdminData")]
    partial class SeedTestAdminData
    {
            ...
            modelBuilder.Entity("CoffeeShopApp.Data.Models.EmployeeModel", b =>
                {
                    ...
                    b.HasData(
                        new { Id = new Guid("978663d3-d310-455f-94c4-3c7a58868c5f"), AccessFailedCount = 0, ConcurrencyStamp = "5cbfbeec-5360-4f71-a65b-2b2f796db4fc", DateofBirth = new DateTime(1980, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Email = "testadmin@coffeeshop.app", EmailConfirmed = true, FirstName = "Test", JMBG = "0101980563922", LastName = "Admin", LockoutEnabled = false, NormalizedEmail = "TESTADMIN@COFFEESHOP.APP", NormalizedUserName = "TESTADMIN", PasswordHash = "AQAAAAEAACcQAAAAEPHQMV7Sq7KZ+/MvASqhLe0qvaVgzaGAVhmQNGnfZreypME++cMbM+zf74lFC0uYbw==", PhoneNumberConfirmed = true, SecurityStamp = "00000000-0000-0000-0000-000000000000", TwoFactorEnabled = false, UserName = "testadmin" }
                    );
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "d595e861-62f6-48c9-90c5-376f635cc26d", ConcurrencyStamp = "0a95eb6b-c558-4471-a074-10524af526b0", Name = "Admin", NormalizedName = "ADMIN" },
                        new { Id = "7995a0b7-b149-480c-965e-9e5be525ec56", ConcurrencyStamp = "e560fb8f-9056-467f-8b46-c4e6ac23f174", Name = "Employee", NormalizedName = "EMPLOYEE" }
                    );
                });
