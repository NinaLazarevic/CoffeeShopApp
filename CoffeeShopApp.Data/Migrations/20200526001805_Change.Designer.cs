...
namespace CoffeeShopApp.Data.Migrations
{
    ...
    [Migration("20200526001805_Change")]
            ...
            modelBuilder.Entity("CoffeeShopApp.Data.Models.EmployeeModel", b =>
                {
                    ...
                    b.HasData(
                        new { Id = new Guid("978663d3-d310-455f-94c4-3c7a58868c5f"), AccessFailedCount = 0, ConcurrencyStamp = "45a1b1e8-138b-40b7-8ce9-df42f7689ed2", DateofBirth = new DateTime(1980, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Email = "testadmin@coffeeshop.app", EmailConfirmed = true, FirstName = "Test", JMBG = "0101980563922", LastName = "Admin", LockoutEnabled = false, NormalizedEmail = "TESTADMIN@COFFEESHOP.APP", NormalizedUserName = "TESTADMIN", PasswordHash = "AQAAAAEAACcQAAAAEGcjhUoxby+MHp5V1E5ioOV60KTqcvVA/BWv5cU71i8A1oWWG02kJmS9YZRj+IsLmA==", PhoneNumberConfirmed = true, SecurityStamp = "00000000-0000-0000-0000-000000000000", TwoFactorEnabled = false, UserName = "testadmin" }
                    );
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "d595e861-62f6-48c9-90c5-376f635cc26d", ConcurrencyStamp = "2d7e6af1-36c1-44ab-a0f2-dfc823a62c3c", Name = "Admin", NormalizedName = "ADMIN" },
                        new { Id = "7995a0b7-b149-480c-965e-9e5be525ec56", ConcurrencyStamp = "e4c3c083-c439-46ee-83d1-d8946265bbb6", Name = "Employee", NormalizedName = "EMPLOYEE" }
                    );
                });
